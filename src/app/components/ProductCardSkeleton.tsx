...
export default function ProductCardSkeleton() {
   return (
      <div className="w-full h-fit border overflow-hidden p-0">
         <div className="relative aspect-square overflow-hidden">
            <Skeleton className="w-full h-full rounded-none" />
            {/* Add to Cart icon Skeleton */}
            <Skeleton className="absolute size-8 rounded-full bg-muted-foreground/20 right-2 top-3 z-10" />
            {/* Wishlist icon Skeleton */}
            <Skeleton className="absolute size-8 rounded-full bg-muted-foreground/20 right-2 top-14 z-10" />
         ...
         <CardContent className="p-3">
            <div>
               ...
               <Skeleton className="h-3.5 w-4/5 mb-1" />
            </div>
