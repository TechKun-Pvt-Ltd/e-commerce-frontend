        ...
        <div className='responsive-container w-full'>
            ...
            <div className="md:hidden py-10">
                <div className="flex flex-col items-center text-center gap-4">
                    <h1 className="text-2xl font-semibold">80% OFF on Figurines</h1>
                    <Button
                        variant="ghost"
                        className="w-32 hover:bg-black rounded-full my-2 text-black hover:text-white border p-4 border-black"
                    >
                        Shop Now
                    </Button>
                </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                    <img className='w-full h-[160px] object-cover rounded-md' src="https://i.pinimg.com/736x/f4/5c/36/f45c3603aaf44bf6c97ea64ae0f64c46.jpg" />
                    <img className='w-full h-[160px] object-cover rounded-md' src="https://i.pinimg.com/736x/a2/04/82/a20482c072133079acca7686428e31ae.jpg" />
                    <img className='w-full h-[160px] object-cover rounded-md' src="https://i.pinimg.com/736x/98/a5/39/98a539360514ea653e04c55bec6734ee.jpg" />
                    <img className='w-full h-[160px] object-cover rounded-md' src="https://i.pinimg.com/736x/ab/ce/81/abce81f2c6534c95e60e7c6aa3a807d1.jpg" />
                </div>
            </div>

            {/* Desktop/tablet: keep previous look */}
